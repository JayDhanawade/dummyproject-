...
app.config['MYSQL_PASSWORD'] = 'jaypushpa@1998'
app.config['MYSQL_DB'] = 'project'


mysql = MySQL(app)

app.config["IMAGE_UPLOADS"] = "F:\\DBDA cource\\project files\\darshika code\\try\\static\\uploads"
FILES_DOWLOADS = "F:\\DBDA cource\\project files\\darshika code\\try\\static\\uploads"
